...
-- ============================================
-- Database schema untuk aplikasi POS "Es Coklat Varian Rasa"
-- Premium Version dengan Glassmorphism UI
-- ============================================
...
-- ============================================
-- Authenticated users can view transaction items
CREATE POLICY "Users can view transaction items" ON transaction_items
    FOR SELECT
    USING (auth.role() = 'authenticated');

-- Authenticated users can create transaction items
...
-- ============================================
-- VIEW: Today's Hourly Sales
-- ============================================
CREATE OR REPLACE VIEW todays_hourly_sales AS
SELECT 
...
-- NOTES: User Creation
-- ============================================
-- Buat user melalui Supabase Auth UI atau API
-- 
-- Contoh SQL untuk update role ke admin:
-- UPDATE user_profiles SET role = 'admin' WHERE email = 'admin@escoklat.com';
--
-- Default credentials (setelah dibuat di Auth):
